...
x_test,y_test = dataset.read_test_sets(test_path, img_size,classes)


print("Complete reading input data. Will Now print a snippet of it")
print("Number of files in Training-set:\t{}".format(len(data.train.labels)))
print("No of files in Testing-set:\t\t{}".format(len(x_test)))
...
train(num_iteration=300000) ## 5000 - 125 images - 34 epochs - 34 accuracy
